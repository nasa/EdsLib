...
typedef enum
{
    ...
    SEDS_NODETYPE_PRESENCE_TYPE_CONSTRAINT,
    SEDS_NODETYPE_PRESENCE_RANGE_CONSTRAINT,
    SEDS_NODETYPE_PRESENCE_VALUE_CONSTRAINT,
...
#define SEDSTAG_IN_RANGE(typ, range) \
    (((uint32_t)(typ)) > SEDS_NODETYPE_##range##_FIRST && ((uint32_t)(typ)) < SEDS_NODETYPE_##range##_LAST)
...
#define SEDSTAG_IS_ANY_DATATYPE(t) \
    (SEDSTAG_IS_SCALAR_DATATYPE(t) || SEDSTAG_IS_COMPOUND_DATATYPE(t) || SEDSTAG_IS_DYNAMIC_DATATYPE(t))
