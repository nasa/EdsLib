...
CFE_Status_t CFE_MSG_GetTypeFromMsgId(CFE_SB_MsgId_t MsgId, CFE_MSG_Type_t *Type)
{
    ...
    {
        Params.MsgId.Value = CFE_SB_MsgIdToValue(MsgId);
...
CFE_Status_t CFE_MSG_GetMsgId(const CFE_MSG_Message_t *MsgPtr, CFE_SB_MsgId_t *MsgId)
{
    ...
    Hdr = (const EdsDataType_CFE_HDR_Message_t *)(const void *)MsgPtr;
    CFE_MissionLib_Get_PubSub_Parameters(&Params, Hdr);

    *MsgId = CFE_SB_ValueToMsgId(Params.MsgId.Value);
...
{
    EdsInterface_CFE_SB_SoftwareBus_PubSub_t Params;
    EdsDataType_CFE_HDR_Message_t           *Hdr;
    ...
    Hdr                = (EdsDataType_CFE_HDR_Message_t *)(void *)MsgPtr;
    Params.MsgId.Value = CFE_SB_MsgIdToValue(MsgId);
    CFE_MissionLib_Set_PubSub_Parameters(Hdr, &Params);
