...
#define CFE_MSG_SHDR_PRESENT_MASK_BIT (EdsLabel_CCSDS_SecHdrFlags_Tlm & EdsLabel_CCSDS_SecHdrFlags_Cmd)
#define CFE_MSG_SHDR_TYPE_MASK_BIT    (EdsLabel_CCSDS_SecHdrFlags_Tlm ^ EdsLabel_CCSDS_SecHdrFlags_Cmd)
#define CFE_MSG_SHDR_TYPE_TLM_BIT     (EdsLabel_CCSDS_SecHdrFlags_BareTlm & EdsLabel_CCSDS_SecHdrFlags_Tlm)
#define CFE_MSG_SHDR_TYPE_CMD_BIT     (EdsLabel_CCSDS_SecHdrFlags_BareCmd & EdsLabel_CCSDS_SecHdrFlags_Cmd)
...
CFE_Status_t CFE_MSG_GetHeaderVersion(const CFE_MSG_Message_t *MsgPtr, CFE_MSG_HeaderVersion_t *Version)
{
    ...
    Hdr = (const EdsDataType_CCSDS_CommonHdr_t *)(const void *)MsgPtr;
...
CFE_Status_t CFE_MSG_SetHeaderVersion(CFE_MSG_Message_t *MsgPtr, CFE_MSG_HeaderVersion_t Version)
{
    ...
    Hdr = (EdsDataType_CCSDS_CommonHdr_t *)(void *)MsgPtr;
...
CFE_Status_t CFE_MSG_GetType(const CFE_MSG_Message_t *MsgPtr, CFE_MSG_Type_t *Type)
{
    ...
    {
        case EdsLabel_CCSDS_SecHdrFlags_BareTlm:
        case EdsLabel_CCSDS_SecHdrFlags_Tlm:
            *Type = CFE_MSG_Type_Tlm;
            break;
        case EdsLabel_CCSDS_SecHdrFlags_BareCmd:
        case EdsLabel_CCSDS_SecHdrFlags_Cmd:
