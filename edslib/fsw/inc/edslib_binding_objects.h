...
extern "C"
{
    ...
    struct EdsLib_Binding_DescriptorObject
    {
        ...
        EdsLib_DataTypeDB_TypeInfo_t
            TypeInfo; /**< Information about the component type (size, number of subcomponents, etc) */
    ...
    {
        return (DescrObj->BufferPtr != NULL && EdsLib_Is_Valid(DescrObj->EdsId)
    ...
    EdsLib_Binding_Compatibility_t
    EdsLib_Binding_CheckEdsObjectsCompatible(EdsLib_Binding_DescriptorObject_t *DestObject,
